...
// en cada posición un objeto que va a representar a una persona y tiene la siguiente forma: abajo v
...
var controlAcces = function (queue, event) {
  ...
  //       console.log("qui que es",key)
  //       console.log("que valor es",objeto[key])
  //     }
  //   }
  // }
}
